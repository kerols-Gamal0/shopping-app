          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                child: AspectRatio(aspectRatio: 1, child: SvgPicture.string(AppAssets.underMaintenanceIllustration, fit: BoxFit.scaleDown)),
              ),
              const Spacer(flex: 2),
              ErrorInfo(
                ...
                btnText: "Retry",
                press: () => Navigator.pushNamedAndRemoveUntil(context, AppRoutes.homeRoute, (route) => false),
              ),
            ],
          ),
        ),
